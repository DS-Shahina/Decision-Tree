...
df = pd.read_csv("C:/Datasets_BA/360DigiTMG/DS_India/360DigiTMG DS India Module wise PPTs/Module 14 Decision Tree/New code-pruning/DT_Regression/movies.csv")
df.info()
